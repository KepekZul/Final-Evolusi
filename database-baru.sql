...
MySQL - 5.5.5-10.1.9-MariaDB : Database - web_trainer
*********************************************************************
*/
...
CREATE TABLE `mahasiswa` (
  ...
  `fakultas` varchar(6) DEFAULT NULL,
...
insert  into `mahasiswa`(`email`,`nrp`,`jurusan`,`fakultas`,`angkatan`,`nama`,`alamat`,`hp`,`hapus`) values ('afif@mail.com','5113100172','Informatika','FTIF','2013','afif','Sutorejo','08387769908',0),('kevin@kepek.com','5113100333','Teknik SIstem Informatika','FTIS','2013','Kevin Zulkarnain','Keputih','08199999888877',0);
...
insert  into `trainer`(`id`,`nama`,`nrp`,`jurusan`,`fakultas`,`hp`,`email`,`asal_kota`,`asal_provinsi`,`password`,`deskripsi`,`line`,`twitter`,`facebook`,`angkatan`,`foto`,`hapus`) values (1,'Prasetya Gilang Nuswantara','5113100104','Tekni Informatika','FTIf','082234331833','prasetya.gilang13@mhs.if.its.ac.id','Surabaya','Jawa Timur','b7a84a7b07e3454ab33e0090698da340',NULL,'pgn.gilang','@pgn_gilang','prasetya Gilang','Navigator',NULL,0),(3,'Inyas','5113100104','Informatika','FTIF','08223223242','trainer@email.com','Surabaya','Jawa Timur',NULL,NULL,'dummy','@dummy','dummy trainer','Navigator',NULL,0);
...
CREATE TABLE `training` (
  ...
  `noconfirmedby` varchar(20) DEFAULT NULL,
...
insert  into `training`(`id`,`email`,`nama`,`tanggal_mulai`,`tanggal_selesai`,`lokasi`,`cp`,`deskripsi`,`confirmedby`,`noconfirmedby`,`status`) values (5,'kevin@kepek.com','Training','2016-12-01','2016-12-14','Theatre A','08199988744','Acara ini dilaksanakan dalam rangka memenuhi agenda wajib dari himpunan. Selain itu acara ini juga permintaan langsung dari dekan. mohon kerjasamanya','Inyas','08223223242',1),(7,'kevin@kepek.com','Pelatihan','2016-11-07','2016-12-31','Graha','098472424422','Besar','Inyas','08223223242',2),(8,'afif@mail.com','Seminar Trainer','2016-12-11','2016-12-26','Robotika','08123344566','Acara permintaan Rektor',NULL,NULL,0);
...
insert  into `user`(`id`,`email`,`pass`,`role`,`hapus`) values (1,'pgn.gilang.1994@gmail.com','1a1dc91c907325c69271ddf0c944bc72','admin',0),(2,'prasetya.gilang13@mhs.if.its.ac.id','1a1dc91c907325c69271ddf0c944bc72','trainer',0),(3,'member1@email.com','1a1dc91c907325c69271ddf0c944bc72','member',0),(4,'trainer@email.com','1a1dc91c907325c69271ddf0c944bc72','trainer',0),(5,'admin@trainer.com','1a1dc91c907325c69271ddf0c944bc72','admin',0),(8,'afif@mail.com','1a1dc91c907325c69271ddf0c944bc72','user',1),(9,'kevin@kepek.com','1a1dc91c907325c69271ddf0c944bc72','user',0);
