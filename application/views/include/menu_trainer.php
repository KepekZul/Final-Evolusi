  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4">
        <!-- Logo. -->
        <div class="logo">
          <h1><a href="javascript:void(0)" onclick="href.location='#';">Halaman Trainer</a></h1>
        </div>
        <!-- Logo ends -->
      </div>
...
<div class="content">
  ...
  <div class="sidebar">
    ...
    <ul id="nav">
      ...
      <li><a href="javascript:void(0)" onclick="href.location='<?php echo site_url("trainer/list"); ?>';"><i class="fa fa-home"></i> Trainer</a></li>
      ...
      <li><a href="javascript:void(0)" onclick="href.location='<?php echo site_url("trainer/data"); ?>';"><i class="fa fa-home"></i> Data Diri</a></li>
