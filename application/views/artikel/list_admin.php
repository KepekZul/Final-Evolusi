          ...
          <div class="widget">
            <div class="widget-head">
              ...
              <div class="widget-icons pull-right">
                <a href="javascript:void(0)" onclick="href.location='<?php echo base_url(); ?>artikel/tambah_artikel';"><i class="fa fa-plus"> Tambah Baru</i></a>
              </div>
              <div class="clearfix"></div>
            </div>
                      ...
                      <?php $nomor = 1; ?>
                        <?php foreach($artikel as $ar){ ?>
                          <tr>
                            ...
                            <td>
                              <a href="javascript:void(0)" onclick="href.location='<?php echo base_url(); ?>artikel/detail_artikel/<?php echo $ar->id; ?>';" data-toggle="tooltip"
                              ...
                              <a href="javascript:void(0)" onclick="href.location='<?php echo base_url(); ?>artikel/hapus_artikel/<?php echo $ar->id ?>';">
