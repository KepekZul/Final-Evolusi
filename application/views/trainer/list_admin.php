            ...
            <div class="widget-head">
              ...
              <div class="widget-icons pull-right">
                <?php if ($this->session->userdata('role') == 'admin'){ ?>
                  <a href="<?php echo base_url(); ?>trainer/tambah_trainer"><i class="fa fa-plus"> Tambah Baru</i></a>
                  <?php } ?>
                </div>
                <div class="clearfix"></div>
              </div>
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <?php if ($this->session->userdata('role') == 'admin'){ ?>
                                  ...
                                  <a href="<?php echo base_url(); ?>trainer/hapus_trainer/<?php echo $ar->id ?>"><button class="btn btn-xs btn-danger" data-toggle="tooltip" title="Hapus"><i class="fa fa-times"></i> </button></a>
                                  <?php } ?>
