          ...
          <div class="widget">
            <div class="widget-head">
              ...
              <div class="widget-icons pull-right">
                <a href="<?php echo base_url(); ?>lomba/tambah_lomba"><i class="fa fa-plus"> Tambah Baru</i></a>
              </div>
              <div class="clearfix"></div>
            </div>
                      ...
                      <tbody>
                        <?php foreach($lomba as $ar){ ?>
                          <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url(); ?>lomba/detail_lomba/<?php echo $ar->id; ?>" data-toggle="tooltip" title="Detail"><button class="btn btn-xs btn-success"><i class="fa fa-search-plus"></i> </button></a>
                              ...
                              <a href="<?php echo base_url(); ?>lomba/hapus_lomba/<?php echo $ar->id ?>"><button class="btn btn-xs btn-danger" data-toggle="tooltip" title="Hapus"><i class="fa fa-times"></i> </button></a>
                            </td>
                          </tr>
                          <?php } ?>
                        </tbody>
