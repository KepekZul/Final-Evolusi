...
<div class="mainbar">
  ...
  <div class="page-head">
    ...
    <div class="bread-crumb pull-right">
      ...
      <a href="#" class="bread-current">List Lomba</a>
    </div>
          ...
          <div class="widget">
            <div class="widget-head">
              ...
              <div class="widget-icons pull-right">
                <a href="<?php echo site_url("lomba/tambah"); ?>"><i class="fa fa-plus"> Tambah Baru</i></a>
              </div>
              <div class="clearfix"></div>
            </div>
                      ...
                      <?php $nomor = 1; ?>
                        <?php foreach($lomba as $ar){ ?>
                          <tr>
                            ...
                            <td>
                              <a href="<?php echo site_url("lomba/detail/$ar->id"); ?>" data-toggle="tooltip" title="Detail"><button class="btn btn-xs btn-success"><i class="fa fa-search-plus"></i> </button></a>
                              ...
                              <a href="<?php echo site_url("lomba/hapus/$ar->id"); ?>"><button class="btn btn-xs btn-danger" data-toggle="tooltip" title="Hapus"><i class="fa fa-times"></i> </button></a>
                            </td>
                          </tr>
                          <?php  $nomor = $nomor + 1 ;} ?>
                        </tbody>
