                ...
                <div class="blog-item">
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-10 blog-content">
                      ...
                      <a class="btn btn-primary readmore" href="javascript:void(0)" onclick="location.href='<?php echo site_url("berita/detail/$ar->id"); ?>';">Read More <i class="fa fa-angle-right"></i></a>
                    </div>
                  </div>
                </div><!--/.blog-item-->
                <?php } ?>
