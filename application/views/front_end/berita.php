                ...
                <div class="blog-item">
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-10 blog-content">
                      <h2><a href="<?php echo site_url("berita/detail_berita/$ar->id"); ?>"><?php echo $ar->judul; ?></a></h2>
                      ...
                      <a class="btn btn-primary readmore" href="<?php echo site_url("berita/detail_berita/$ar->id"); ?>">Read More <i class="fa fa-angle-right"></i></a>
                    </div>
                  </div>
                </div><!--/.blog-item-->
                <?php } ?>
            ...
            <div class="row" style="text-align:center;">
              <ul class="pagination pagination-lg" style="text-align:center;">
                <?php if($awal != 1) {  $prev = $awal - 3;?>
                  <li><a href="<?php echo site_url("berita/index/all/$prev/3"); ?>"><i class="fa fa-long-arrow-left"></i>Previous Page</a></li>
                <?php } ?>

                <?php if($akhir < $jumlah) { $next = $awal + 3;?>
                  <li><a href="<?php echo site_url("berita/index/all/$next/3"); ?>"">Next Page<i class="fa fa-long-arrow-right"></i></a></li>
                <?php } ?>
                </ul><!--/.pagination-->
            </div>
