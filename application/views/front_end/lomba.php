      ...
      <div class="row" style="text-align:center;">
        <ul class="pagination pagination-lg" style="text-align:center;">
          <?php if($awal != 1) { $prev = $awal - 3; ?>
            <li><a href="<?php echo site_url("lomba/index/all/$prev/3"); ?>"><i class="fa fa-long-arrow-left"></i>Previous Page</a></li>
            <?php } ?>
            
            <?php if($akhir < $jumlah) { $next = $awal + 3; ?>
              <li><a href="<?php echo site_url("lomba/index/all/$next/3"); ?>">Next Page<i class="fa fa-long-arrow-right"></i></a></li>
              <?php } ?>
            </ul><!--/.pagination-->
          </div>
